      ...
      >
        <div className="max-w-5xl mx-auto px-4 sm:px-6 py-8">
          ...
          <div className="mt-8 pt-6 border-t border-[var(--border)] flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <p className="text-xs text-[var(--text-muted)]">
              Made with care for Windows users by <a href="https://ragzus.me/" target="_blank" rel="noopener noreferrer" className="text-[var(--text-primary)] hover:underline transition-colors">Raghav Dadhich</a>
            </p>
          </div>
        </div>
      </motion.div>
